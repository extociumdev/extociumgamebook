...
* Tap the **gear icon** to fine-tune auto settings (requires [**TP**](traning.md#eng)).
...
* **기어 아이콘**을 눌러 자동 설정을 조정하세요 ([**TP**](traning.md#undefined-1) **필요**).
...
* **オート**ボタンを押すと自動狩り開始！
* **ギアアイコン**で詳細設定可能（[**TP**](traning.md#ri-ben-yu)**が必要**）。
