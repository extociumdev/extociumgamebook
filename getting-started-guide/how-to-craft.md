...
The first is, as shown above, where you need to learn the crafting method through '[Traning](how-to-training.md#eng)'. Earn TP through hunting to refine your crafting skills.
...
첫 번째로는 위 화면 처럼, '[기술 연마](how-to-training.md#undefined-1)'를 통해 제작법을 익혀야 하는 경우입니다. 사냥을 통해 TP를 획득하여 제작 기술을 연마해보세요.
...
👉製作が不可能な場合は二つあります。最初の場合は、上の画面のように、「[技術研磨](how-to-training.md#ri-ben-yu)」を通じて製作法を学ぶ必要があります。狩りを通じてTPを獲得し、製作技術を磨きましょう。
