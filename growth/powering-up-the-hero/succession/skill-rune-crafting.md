...
Before crafting a Skill Rune, you must first **learn the material crafting method** in [**Training**](../../../getting-started-guide/how-to-training.md#eng) **> Mineralogy**.\
...
스킬 룬 제작을 위해서는 먼저 [**기술 연마**](../../../getting-started-guide/how-to-training.md#undefined-1) **> 광물학**에서 **재료 제작 방법을 습득**해야 합니다.\
...
スキルルーンを製作するには、まず [**スキル修練**](../../../getting-started-guide/how-to-training.md#ri-ben-yu) **> 鉱物学** にて **材料の製作方法を習得する必要がございます**。\
