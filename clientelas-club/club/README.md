...
<figure><img src="../../.gitbook/assets/club (1).png" alt=""><figcaption></figcaption></figure>
...
{% content-ref url="create-club.md" %}
...
{% content-ref url="club-management.md" %}
...
{% content-ref url="club-warehouse.md" %}
