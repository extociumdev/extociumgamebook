...
In EXTOCIUM,\
you can create **Hero and Equipment NFTs**\
using resources earned through gameplay.

On this page,\
👉 _simply choose **which NFT you want to mint right now**._
...
NFTs are minted to your **wallet**, not your game account.\
👇 Please make sure to **connect your wallet before minting**.

{% content-ref url="../wallet-connection/wallet-setup/" %}
[wallet-setup](../wallet-connection/wallet-setup/)
{% endcontent-ref %}
{% endtab %}
...
엑스토시움에서는\
**게임 플레이로 얻은 자원으로 영웅과 장비를 NFT로 제작**할 수 있어요.

이 페이지에서는\
👉 _지금 만들고 싶은 NFT가 무엇인지 선&#xD0DD;_&#xD558;면 됩니다.
...
NFT는 **게임 계정이 아닌 지갑으로 발행**됩니다.\
👇 민팅 전, 반드시 지갑을 연결해 주세요.
...
NFTはゲームアカウントではなく、**ウォレットに発行**されます。\
👇 ミント前に、必ずウォレットを接続してください。
