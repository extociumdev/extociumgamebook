...
블록체인 지갑은\
**NFT와 게임 아이템 같은 디지털 자산을 안전하게 보관하고 관리하는 도구**입니다.

조금 쉽게 설명하면,\
블록체인 지갑은 **게임 속 아이템을 담아두는 개인 전용 금고**와 같은 역할을 합니다.

이 지갑이 있어야만\
블록체인 기반 게임이나 서비스에서\
자산을 직접 소유하고 사용할 수 있습니다.
...
* NFT 영웅과 아이템을 보관합니다.
* 게임이나 서비스와 지갑을 연결합니다.
* 자산을 이동하거나 거래할 때 직접 승인합니다.

즉,\
👉 **지갑은 블록체인 게임을 이용하기 위한 기본 도구입니다.**
...
메타마스크는\
**전 세계에서 가장 널리 사용되는 블록체인 지갑 중 하나**입니다.

* 웹 브라우저 확장 프로그램과 모바일 앱을 지원합니다.
* NFT와 토큰을 직접 관리할 수 있습니다.
* 다양한 블록체인 게임과 서비스에서 사용되고 있습니다.
...
### 🛡️ Trust Wallet (트러스트 월렛)

트러스트 월렛은\
**모바일 환경에 최적화된 블록체인 지갑**입니다.
...
* 🔑 **NFT 영웅과 아이템은 게임 회사가 아니라**\
  **플레이어의 지갑이 직접 소유합니다.**
* ✍️ **NFT를 거래하거나 이동할 때는**\
  **반드시 지갑에서 거래 승인(서명)을 해야 합니다.**

이 승인 과정은\
해당 행동이 **플레이어 본인의 의사로 진행되는 것임을 확인하는 절차**입니다.
...
EXTOCIUM에서는\
게임 자산을 블록체인에 기록하고 관리하기 위해\
**MetaMask 또는 Trust Wallet 연결이 필요합니다.**

지갑을 연결하면 다음과 같은 기능을 사용할 수 있습니다.

* NFT 영웅 및 아이템의 소유 및 관리
* 다른 유저와의 거래
* 게임 자산의 안전한 보관
