...
* [When my energy reaches 0, a debuff is applied that significantly reduces my damage during PK.](../system/energy/0-energy-penalty.md#eng)
...
* [에너지가 0이 되면, PK시 나의 데미지가 대폭 감소되는 디버프가 부여됩니다.](../system/energy/0-energy-penalty.md#undefined-1)
...
* [エネルギーが0になると、PK時に私のダメージが大幅に減少するデバフが適用されます。](../system/energy/0-energy-penalty.md#ri-ben-yu)
